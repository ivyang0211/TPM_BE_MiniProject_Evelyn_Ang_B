...
<head>
    ...
    <title>EDIT DATA - ID {{ $plane->id }}</title>
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="card-form">
        ...
        <form action="{{ route('plane.update', $plane->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <label for="imageUpload">Plane Image :</label>
                <input type="file" name="imageEdit" id="imageEdit" >
        
                <label for="name">Plane Name:</label>
                <input value="{{ $plane->name }}" type="text" name="name" id="name" required>
        
                <label for="type">Type:</label>
                <input value="{{ $plane->type }}" type="text" name="type" id="type" required>
        
                <label for="brand">Brand:</label>
                <input value="{{ $plane->brand }}" type="text" name="brand" id="brand" required>
        
                <label for="quantity">Quantity:</label>
                <input value="{{ $plane->quantity }}" type="number" name="quantity" id="quantity" required>
